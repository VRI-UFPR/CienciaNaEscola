                    ...
                    {isAndroid && installPrompt && !isIOSInstructions && (
                        <div className="d-flex flex-column align-items-center w-100">
                            <p className="text-center fw-medium lh-sm fs-6 mx-4 mb-4">
                                As funcionalidades do app só estão disponíveis após a instalação. Clique no botão abaixo para instalar ou
                                siga para dashboard.
                            </p>
                    ...
                    {(isIos || isIOSInstructions) && (
                        <div className="d-flex flex-column align-items-center w-100 mx-4">
                            <p className="text-center fw-medium lh-sm fs-6">
                                As funcionalidades do app só estão disponíveis após a instalação. Instale conforme as instruções abaixo ou
                                siga para a dashboard.
                            </p>
                    ...
                    {!isAndroid && !isIos && (
                        <div className="d-flex flex-column align-items-center w-100 mx-4">
                            <p className="text-center fw-medium lh-sm fs-6 mb-4">
                                ...
                                abaixo para acessar o app em seu celular ou siga para a dashboard.
                            </p>
                            <img src={HomeQRCode} alt="QR Code para download do aplicativo" className="mb-4 mw-150" />
                        </div>
                    )}
                    <div className="row justify-content-center w-75 g-0">
                        <div className="col-12 col-lg-6">
                            <TextButton
                                hsl={[97, 43, 70]}
