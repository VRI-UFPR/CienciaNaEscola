                        ...
                        return itemGroup.items.map((item) => {
                            switch (item.type) {
                                ...
                                case 'DATEBOX':
                                    return (
                                        <div key={item.id} className="row justify-content-center m-0 pt-3">
                                            {<DateInput item={item} group={itemGroup.id} onAnswerChange={() => {}} disabled={true} />}
                                        </div>
                                    );
                                case 'TIMEBOX':
                                    return (
                                        <div key={item.id} className="row justify-content-center m-0 pt-3">
                                            {<TimeInput item={item} group={itemGroup.id} onAnswerChange={() => {}} disabled={true} />}
                                        </div>
                                    );
                                case 'LOCATIONBOX':
                                    return (
                                        <div key={item.id} className="row justify-content-center m-0 pt-3">
                                            {<LocationInput item={item} group={itemGroup.id} onAnswerChange={() => {}} disabled={true} />}
                                        </div>
                                    );
                                case 'UPLOAD':
                                    return (
                                        <div key={item.id} className="row justify-content-center m-0 pt-3">
                                            {<ImageInput item={item} group={itemGroup.id} onAnswerChange={() => {}} disabled={true} />}
                                        </div>
                                    );
                                case 'TEXT':
                                    return (
